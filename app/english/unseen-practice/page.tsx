                    ...
                    <div className="space-y-6" dir="ltr">
                      {unseen.paragraphs.map((para, idx) => {
                        ...
                        return (
                          ...
                          >
                            <span className="absolute -top-3 left-4 text-[9px] font-black bg-teal-500/10 px-2 py-0.5 rounded-full border border-teal-500/20 text-teal-400">
                              Paragraph {idx + 1}
                            </span>
                            <p className="text-sm md:text-base leading-relaxed text-zinc-100 font-medium pt-2 select-text" style={{ color: isLight ? '#27272a' : '#f4f4f5' }}>
                              {para}
                            </p>
                          </div>
                        );
